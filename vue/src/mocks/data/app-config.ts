/**
 * Mock ApplicationConfigurationDto — 模拟后端 /api/abp/application-configuration 响应
 *
 * 所有页面需要的权限策略全设为 true，确保 Mock 模式下所有页面可访问。
 */
import type { ApplicationConfigurationDto } from '@/types/abp'
import { TenantUserSharingStrategy } from '@/types/abp'

export const mockAppConfig: ApplicationConfigurationDto = {
  auth: {
    grantedPolicies: {
